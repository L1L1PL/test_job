...
theme: /
    ...
    state: Rules
        ...
        state: Нет
            ...
            q!: $regex</rules>
            a: Правила игры:
            a: Я загадаю четырехзначное число, в котором все цифры разные. Твоя задача - угадать мое число. В процессе игры я буду давать тебе подсказки. Например, если я загадал число 1234, а ты ввел 2134, то я напишу: "Результат: две «коровы» (две цифры: «1»,«2» — угаданы на неверных позициях) и два «быка» (две цифры: «3», «4» - угадана вплоть до позиции)". Удачи!)
